      ...
      >
        ...
        >
          <Combobox
            ...
            onChange={(projects) =>
              (window.location = `/projects/${projects._id}`)
            }
          >
            <div className='relative'>
              <Combobox.Input
                className='h-12 w-full border-0 bg-transparent pl-11 pr-4 outline-none text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm'
                placeholder='Search...'
